# Formal Verification 鈥?Problem 165
...
```lean
Ulam165HistoricalBall.historical_closed_ball_problem165_negative
```

## Development source path

```text
PaperFormalization/Ulam 165/Main.lean
```
...
No user-defined mathematical axiom occurs in the recorded principal theorem.
...
Therefore this record is **F1, not F2**.
